...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"icplaza", "token", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Tokens_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"icplaza", "token", "tokens"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Token_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"icplaza", "token", "tokens", "symbol"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Fees_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"icplaza", "token", "tokens", "symbol", "fees"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Burntoken_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"icplaza", "token", "symbol", "burnt"}, "", runtime.AssumeColonVerbOpt(true)))
)
