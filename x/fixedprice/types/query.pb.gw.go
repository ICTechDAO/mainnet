...
var (
	pattern_Query_Orders_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"icplaza", "fixedprice", "orders"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Order_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"icplaza", "fixedprice", "order", "token_id"}, "", runtime.AssumeColonVerbOpt(true)))
)
