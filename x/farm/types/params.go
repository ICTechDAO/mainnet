...
var (
	...
	DefaultCreatePoolFee       = sdk.NewCoin("ugauss", sdk.NewInt(10000000)) // 5000stake
	DefaultMaxRewardCategories = uint32(5)
)
...
func (p *Params) ParamSetPairs() paramstypes.ParamSetPairs {
	return paramstypes.ParamSetPairs{
		paramstypes.NewParamSetPair(KeyCreatePoolFee, &p.CreatingPoolFee, validateCreatePoolFee),
...
func (p Params) Validate() error {
	return validateCreatePoolFee(p.CreatingPoolFee)
}
