module github.com/gauss/gauss/v6
...
replace (
	...
	github.com/cosmos/cosmos-sdk => ../cosmos-sdk-icplaza@v0.45.5
	github.com/cosmos/ibc-go/v3 => ../ibc-go@v3.1.0
	github.com/evmos/ethermint => ../ethermint@v0.17.1
